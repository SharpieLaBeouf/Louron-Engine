...
private:
	...
	std::unordered_map<std::string, bool> m_ActiveGUIWindows;
...
private:
	...
	public:
		void handleFileAction(efsw::WatchID watchid, const std::string& dir, const std::string& filename, efsw::Action action, std::string oldFilename) override {
			...
			if (dir.find("Script Core API") != std::string::npos || dir.find("Binaries") != std::string::npos || (dir.find("Generated") != std::string::npos && filename == "AutoGenerated_Reflection.cpp"))
				return;

			// Set atomic bool
			if (std::filesystem::path(dir + filename).extension() == ".h" || std::filesystem::path(dir + filename).extension() == ".cpp" || std::filesystem::path(dir + filename).extension() == ".hpp")
			{
