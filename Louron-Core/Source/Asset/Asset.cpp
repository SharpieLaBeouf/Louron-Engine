...
namespace Louron {
	...
	std::string AssetUtils::AssetTypeToString(AssetType type)
	{
		...
		switch (type) {
			...
			case AssetType::AnimationStateMachine:	type_string = "AssetType::AnimationStateMachine";	break;
	...
	AssetType AssetUtils::AssetTypeFromString(const std::string& assetType)
	{
		...
		if (assetType == "AssetType::AnimationStateMachine")	return AssetType::AnimationStateMachine;
